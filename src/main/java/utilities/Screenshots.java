...
public class Screenshots {
	...
	public static void setScenario(Scenario scenario) {
		Screenshots.myScenario = scenario;
	}
...
//			Reporter.addScreenCaptureFromPath(fileA.getAbsolutePath());
			myScenario.attach(Files.readAllBytes(fileA.toPath()), "image/png","image");
//			Reporter.addScreenCaptureFromPath(fileB.getAbsolutePath());
			myScenario.attach(Files.readAllBytes(fileB.toPath()), "image/png","image");
		} catch (IOException e) {
			e.printStackTrace();
		}
